...
Fonte: lista oficial `[F3] PROJETOS/`, registrada em `2026-07-18-lista-projetos-f3.md`.

## Tese de organização
Em vez de olhar 92 projetos como lista solta, organizar como um portfólio de vida/holding pessoal:

1. Pessoa e Fundador
2. Família, Casa e Base de Vida
3. Saúde, Corpo e Energia
4. Finanças, Patrimônio e Liberdade
5. Educação e Capital Intelectual
6. Carreira, Imagem e Autoridade
7. Empresas, LÓGIKA e Operação Profissional
8. Mídia, Conteúdo e Audiência
9. Cultura, Arte e Projetos Autorais
10. Espiritualidade, Filantropia e Legado
11. Sistema Pessoal, Produtividade e Governança

## Classificação inicial por macrocontexto
...
Há duplicidades e variações claras que podem ser consolidadas depois, por exemplo: carro novo/trocar carro/comprar carro; aprender inglês e espanhol com versão pessoal; educação financeira com versão propósitos; Fio da Memória em andamento e a iniciar; Entre Tempos em andamento e pausado.

## Próximo passo recomendado
Criar uma camada de governança com 3 níveis:
- Impérios: macrocontextos.
- Frentes: agrupamentos operacionais dentro de cada império.
- Projetos: iniciativas concretas com dono, próximo passo, prazo e métrica.
