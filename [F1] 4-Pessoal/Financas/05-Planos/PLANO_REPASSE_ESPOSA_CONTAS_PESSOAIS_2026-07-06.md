...
Data: 2026-07-06
Escopo: finanças pessoais de Jadielson. Não misturar com LÓGIKA/empresa.

## Decisões informadas por Jadielson

- Retirar a prestação da moto do repasse, pois a esposa paga diretamente.
- Itens da Eloáh são voláteis; esposa deve controlar em tabela própria.
- Seguros e internet: Jadielson repassará os carnês mensalmente.
- Combustível é volátil e deve ficar em controle separado.
- Luz e água chegam pelo WhatsApp.
- Compras de mercado serão tabeladas inicialmente em R$ 1.000,00/mês.

## Base fixa revisada para repasse/controle

| Despesa | Valor de referência | Forma de controle |
|---|---:|---|
| Financiamento casa | R$ 550,00 | boleto/carnê |
| Luz | R$ 150,00 | conta pelo WhatsApp |
| Água | R$ 72,80 | conta pelo WhatsApp |
| Plano funeral | R$ 51,90 | recorrente |
| Mercado/alimentação | R$ 1.000,00 | teto mensal inicial |
| Prestação carro | R$ 995,13 | boleto/carnê |
| Escola Eloáh | R$ 380,00 | boleto |
| Seguro carro | R$ 95,00 | carnê mensal |
| Seguro moto | R$ 50,00 | carnê mensal |
| Internet | R$ 126,00 | carnê mensal |
| Plano telefônico | R$ 46,31 | confirmar se entra no repasse |
| Água mineral | R$ 36,00 | confirmar se entra no repasse |
| iCloud | R$ 66,90 | assinatura pessoal |

Total de referência com todos os itens acima: R$ 3.620,04.

## Itens retirados ou separados

| Item | Valor | Tratamento |
|---|---:|---|
| Prestação moto | R$ 683,00 | fora do repasse; esposa paga diretamente |
| Itens Eloáh | volátil | controlar em tabela própria |
| Combustível | volátil / referência antiga R$ 480,00 | controlar separado |
| Cartão pessoal | referência antiga ~R$ 500,00 | não misturar no repasse automático |
| BS2 | R$ 1.400,00 | quitação separada, apenas se couber no caixa |
| Consignados | R$ 1.960,96/mês | já descontados em folha; não repassar |

## Próximo passo recomendado

Criar uma tabela simples mensal para a esposa com colunas: Conta, Valor previsto, Valor pago, Data de vencimento, Forma de recebimento da conta, Observação.

## Ajuste — assinaturas no cartão ficam fora do repasse

Confirmação de Jadielson: qualquer assinatura lançada no cartão deve ficar fora do repasse à esposa, pois o cartão já desconta/concentra esses lançamentos.

### Base limpa para repasse mensal
...
**Total base limpa para repasse:** R$ 3.470,83/mês.

### Fora do repasse base
