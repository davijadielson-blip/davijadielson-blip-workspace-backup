...
Data: 2026-07-06  
Responsável pelo plano: Warren  
Escopo: finanças pessoais de Jadielson. Não misturar com LÓGIKA/empresa nem despesas da mãe.

## Objetivo

Criar uma base mensal simples para Jadielson transferir à esposa, permitindo que ela ajude na quitação e controle das contas fixas/essenciais.

## Base limpa atual do repasse
...
| Mercado/alimentação | R$ 1.000,00 | teto inicial definido por Jadielson |
...
| Plano TIM pessoal | R$ 46,99 | plano de Jadielson |
| Plano Claro pessoal | R$ 69,90 | plano de Jadielson |

**Total base limpa:** **R$ 3.623,72/mês**.

## Fora da base limpa

| Item | Tratamento |
|---|---|
| Prestação da moto | Fora do repasse; esposa paga diretamente |
...
| Consignados | Já descontados em folha; não repassar |
| BS2 | Quitação separada, apenas se couber no caixa |
| Despesas da mãe | Bloco separado, não misturar com a base principal |

## Despesas da mãe — bloco separado

Confirmado por Jadielson que as despesas da mãe ficam separadas da base principal:

- Telefone TIM dela: valor a confirmar.
- Claro empresa: valor a confirmar e separar conforme natureza empresarial.
- Energia: valor a confirmar.

## Regra operacional

- A base de R$ 3.623,72 serve como referência mensal para repasse/controle.
