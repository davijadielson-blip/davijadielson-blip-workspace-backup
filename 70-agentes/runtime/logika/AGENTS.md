---
tema: runtime dos agentes empresariais da Logika
conteudo: regras comuns para Jarvis e o Conselho C-Level no OpenClaw
...
- `jarvis`: coordenação empresarial e operacional da LÓGIKA.
- `caio`: inteligência artificial e automação.
- `cro`: receita, comercial e vendas.
- `cco`: criação e audiovisual.
- `cmo`: marketing e marca.
- `coo`: operações e escala.
