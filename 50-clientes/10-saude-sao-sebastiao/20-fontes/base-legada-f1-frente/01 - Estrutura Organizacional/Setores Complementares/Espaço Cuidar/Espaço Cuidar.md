...
> Centro de atenção especializada ambulatorial · Secretaria Municipal de Saúde — São Sebastião, AL
...
| Campo | Dado |
|---|---|
| Tipo | Centro de Especialidades Municipal |
| Modelo | Atenção ambulatorial especializada |
| Acesso | Via encaminhamento pelos PSFs e UBSs |
...
1. Usuário identificado no PSF ou UBS com necessidade especializada
2. Médico emite solicitação/guia de encaminhamento
3. Agendamento via regulação municipal no Espaço Cuidar
4. Atendimento especializado
5. Contrarreferência para a unidade de origem com orientações

---

## Integração na Rede

- Recebe referência de todos os [[../PSFs/00 - PSFs - MOC|PSFs]] e [[../UBSs/00 - UBSs - MOC|UBSs]]
- Articulação com [[CAPS]] para casos de psiquiatria e saúde mental
- Complementa a [[Atenção Básica]] sem substituí-la
- Casos de maior complexidade: [[../../../04 - Rede e Referências/Referência Hospitalar|referenciados para Arapiraca/Maceió]]

---

## Ideias de Conteúdo

- Post: "Especialidades gratuitas em São Sebastião — conheça o Espaço Cuidar"
- Card: lista de especialidades disponíveis e como acessar
- Post: "Da UBS ao Espaço Cuidar — o caminho da saúde especializada"
- Infográfico do fluxo de encaminhamento
- Destaque por especialidade: "Sabia que temos ultrassom aqui no município?"
