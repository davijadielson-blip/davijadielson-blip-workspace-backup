...
Bilhete de identidade do {NOME_AGENTE} (nome, modelo, etc)

Boot

SOUL.md

Personalidade — como o {NOME_AGENTE} pensa e fala

Boot (passo 1)

USER.md

Sobre o {NOME_USER} — quem é, o que faz, tom preferido
...
memory/projects/{nome}.md

Skills instaladas

skills/_registry.md

Histórico de algo arquivado
...
Skill nova instalada

NÃO (atualizar skills/{categoria}/_registry.md)

Pasta principal nova criada

SIM

Decisão importante registrada

NÃO (vai pra memory/decisoes/)

Estrutura de subpasta mudou

NÃO (atualizar MAPA local da pasta)

Criado pelo wizard-workspace do Starter Kit OpenClaw v2. Veja Exemplos da Amora/MAPA-amora.md pra exemplo maduro de workspace.
