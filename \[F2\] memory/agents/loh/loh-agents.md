...
> **WORKSPACE É FONTE DE VERDADE.** Tudo fica em `/data/.openclaw/workspace/`.
> **GitHub** é **backup apenas** — cron diário 03:00 BRT.
- Nunca escreva direto no GitHub. Salve sempre no workspace.
- Nunca consulte o GitHub como fonte primária. Leia do workspace.
- O clone local (`/data/.openclaw/segundo-cerebro-jadielson/`) existe apenas como destino de backup.
